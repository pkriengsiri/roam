...
module.exports = {
  getImage: function (req, res) {
    ...
    // axios
    //   .get(
    //     `https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=${req.data.destination}&inputtype=textquery&fields=name,photos&key=${process.env.PLACES_API_KEY}`
    //   )
    //   .then((response) => {
