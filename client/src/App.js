      ...
      <Router>
        ...
        <main className="page">
            ...
            <Switch>
              ...
              <Route exact path="/user/:userId/trips" component={AllTrips}/>
              {/* // All my trips */}
              <Route exact path="/user/:userId/edit" component={EditUser} />
              <Route exact path="/user/:userId/trips/new" component={CreateTrip} />
              <Route exact path="/user/:userId/trips/:tripId" component={SingleTrip} />
              <Route exact path="/user/:userId/trips/:tripId/edit" component={EditTrip} />
            </Switch>
        </main>
        <Footer />
      </Router>
